...
# Generation Time: 2013-05-08 00:49:03 +0000
# ************************************************************
...
CREATE TABLE `business` (
  ...
  `guid` varchar(20) NOT NULL DEFAULT '',
...
CREATE TABLE `checkin` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `businessGuid` varchar(20) DEFAULT '0',
...
CREATE TABLE `review` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `userGuid` varchar(20) DEFAULT NULL,
  `businessGuid` varchar(20) DEFAULT NULL,
